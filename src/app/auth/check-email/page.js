    ...
    <div className="min-h-screen bg-primary-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-primary-panel rounded-panel p-8 text-center">
          ...
          <div className="bg-primary-800 border border-primary-700 rounded-control p-4 mb-6">
            ...
            <div
              className={`mb-4 p-3 rounded-control text-sm ${
                resendMessage.includes("Error")
                  ? "bg-signal-alert/10 border border-signal-alert/40 text-signal-alert"
          ...
          <div className="space-y-3">
            {email && (
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-primary-700 text-primary-50 py-2 px-4 rounded-control font-semibold hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <RefreshCw
            ...
            <Link
              href="/auth/signin"
              className="flex items-center justify-center space-x-2 w-full bg-accent-400 text-primary-900 py-3 px-4 rounded-control font-semibold transform hover:scale-105 transition-all duration-200"
            >
            ...
            <Link
              href="/auth/signup"
              className="block w-full text-center text-accent-400 hover:text-accent-300 font-medium py-2"
            >
