...
const COPY = {
  en: {
    ...
    adminGrantBody:
      "Your access was manually granted by the Global Player team. Contact support@globalplayerpro.com for changes.",
  },
  pt: {
    back: "Painel",
    eyebrow: "Cobrança",
    ...
    adminGrantBody:
      "Seu acesso foi liberado manualmente pela equipe Global Player. Fale com support@globalplayerpro.com para alterações.",
  },
};
