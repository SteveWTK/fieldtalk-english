...
export const FORMATIONS = {
  "4-3-3": {
    ...
    slots: [
      ...
      { id: "LB", label: "LB", x: "15%", y: "75%", accepts: ["LB", "DF"] },
      { id: "CB1", label: "CB", x: "37%", y: "78%", accepts: ["CB", "DF"] },
      { id: "CB2", label: "CB", x: "63%", y: "78%", accepts: ["CB", "DF"] },
      { id: "RB", label: "RB", x: "85%", y: "75%", accepts: ["RB", "DF"] },
      {
        id: "CM1",
        label: "CM",
        x: "30%",
      ...
      { id: "ST", label: "ST", x: "50%", y: "18%", accepts: ["ST", "FW"] },
      {
        id: "RW",
        label: "RW",
        x: "82%",
